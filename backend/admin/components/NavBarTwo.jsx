...
const navigation = [
  ...
  { name: 'Ejercicios', href: '#', current: false },
  { name: 'Rutinas', href: '#', current: false },
  { name: 'Estadisticas', href: '#', current: false }
];

//const navigationNoLogged = [{ name: 'Login', href: 'api/auth/login', current: true }];
const navigationNoLogged = [{ name: 'Login', href: '/api/auth/signin', current: true }];
...
export default function NavBarTwo() {
  ...
  const navigationToRender = session ? navigation : navigationNoLogged;
            ...
            <div className="flex h-16 items-center justify-between">
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <LogoShort width="80px" height="60px" />
                </div>
              ...
              <div className="border-t border-gray-700 pt-4 pb-3">
                <div className="flex items-center px-5">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="text-sm font-medium leading-none text-gray-400">{session?.user.name}</div>
                  </div>
                  <button
                    type="button"
